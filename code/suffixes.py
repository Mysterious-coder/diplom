...
verb_suffixes = {
    'from_verb':  [
                   'а', 'е', 'ен', 'ествова', 'ева', 'и', 'ирова', 'изирова', 'ича', 'ка', 'ну', 'нича',
                   'ова', 'о', 'ствова', 'ыва', 'я',
...
morph_wordcreate = {'инск', 'овиан', 'очк', 'am', 'инит', 'ур', 'овенн', 'ность', 'ун', 'охоньки', 'оньк',
                    ...
                    'ествова', 'йн', 'и', 'ист', 'мент', 'ц', 'стви', 'аж', 'омец', 'иот', 'атник', 'ец',
                    ...
                    'ух', 'онк', 'овал', 'ив', 'вск', 'овщин', 'ану', 'ичий', 'овщик', 'щин', 'щик', 'нь',
                    'х', 'ытьб', 'ивн', 'ёжь', 'есс', 'ича', 'ошеньк', 'ок', 'ком', 'овий', 'овк', 'онек',
                    'ень', 'оид', 'ыль', 'иозн', 'оват', 'мен', 'орий', 'от', 'ус', 'елив', 'онок', 'ици',
                    'ци', 'арад', 'ишк', 'ацк', 'итян', 'оныш', 'ык', 'ёл', 'ельн', 'онизм', 'нич', 'н', 'о',
                    ...
                    'ичк', 'ёз', 'ост', 'ын', 'ерий', 'ём', 'ящ', 'еб', 'й', 'з'}
